...
public class BridgeRegTestConstants extends BridgeConstants {
    ...
    BridgeRegTestConstants() {
        ...
        federatorPrivateKeys = Lists.newArrayList(
        ...
        List<ECKey> federationChangeAuthorizedKeys = Arrays.asList(
            ...
            ECKey.fromPublicOnly(Hex.decode("04aff62315e9c18004392a5d9e39496ff5794b2d9f43ab4e8ade64740d7fdfe896969be859b43f26ef5aa4b5a0d11808277b4abfa1a07cc39f2839b89cc2bc6b4c"))
        );
